...
```bash
# Debian 13 estable
curl -O https://raw.githubusercontent.com/Richiestone18/Debian-Mate-Postinstall/main/debian13-mate-postinstall.sh
...
```bash
# Debian Sid
curl -O https://raw.githubusercontent.com/Richiestone18/Debian-Mate-Postinstall/main/debian-sid-mate-postinstall.sh
...
```bash
# Debian 13 estable
wget https://raw.githubusercontent.com/Richiestone18/Debian-Mate-Postinstall/main/debian13-mate-postinstall.sh
chmod +x debian13-mate-postinstall.sh
sudo ./debian13-mate-postinstall.sh
```
...
```bash
# Debian Sid
wget https://raw.githubusercontent.com/Richiestone18/Debian-Mate-Postinstall/main/debian-sid-mate-postinstall.sh
chmod +x debian-sid-mate-postinstall.sh
sudo ./debian-sid-mate-postinstall.sh
```
...
```bash
# Debian 13 estable
curl -sL https://raw.githubusercontent.com/Richiestone18/Debian-Mate-Postinstall/main/debian13-mate-postinstall.sh | sudo bash
```

```bash
# Debian Sid
curl -sL https://raw.githubusercontent.com/Richiestone18/Debian-Mate-Postinstall/main/debian-sid-mate-postinstall.sh | sudo bash
```
